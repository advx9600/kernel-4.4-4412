...
static const u16 wm8978_reg[WM8978_CACHEREGNUM] = {
	...
	0x000,0x000,0x00c,0x1ff,//0x08-0x0b		
	...
	0x000,0x06f,0x1e1,0x1e1,//0x30-0x33 	
	0x13f,0x13f,0x03f,0x13f,//0x34-0x37 
...
//	 	 snd_soc_update_bits(codec, 55, 0x40, 0x40);
		snd_soc_write(codec,WM8978_LOUT2_SPK_CONTROL,0x03f);
		snd_soc_write(codec,WM8978_ROUT2_SPK_CONTROL,0x03f);
...
//			snd_soc_update_bits(codec, 55, 0x40, 0x0);
		snd_soc_write(codec,WM8978_LOUT2_SPK_CONTROL,0x13f);
		snd_soc_write(codec,WM8978_ROUT2_SPK_CONTROL,0x17f);
