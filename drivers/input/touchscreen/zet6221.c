...
#define TS_INT_GPIO	      EXYNOS4_GPX0(4) //RK2928_PIN1_PB0
#define TS_RST_GPIO	      EXYNOS4212_GPM3(3) //RK2928_PIN3_PC1
...
#define  FLASH_SIZE_ZET6270			(0x10000)
...
#define FW_Y_RESOLUTION				(800)		///< the FW setting Y resolution
#define X_MAX	 				(1280)		///< the X resolution of TP AA(Action Area)
#define Y_MAX 					(800)		///< the Y resolution of TP AA(Action Area)
