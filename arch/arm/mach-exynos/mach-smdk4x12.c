...
int g_ddr_vol = 1300;//mv 1200-1500
EXPORT_SYMBOL(g_ddr_vol);
...
#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_I2C
#define CYTTSP5_USE_I2C 1

#ifdef CYTTSP5_USE_I2C
#define CYTTSP5_I2C_TCH_ADR 0x24
#define CYTTSP5_LDR_TCH_ADR 0x24
#define CYTTSP5_I2C_IRQ_GPIO		EXYNOS4_GPX0(4) /* J6.9, C19, GPMC_AD14/GPIO_38 */
#define CYTTSP5_I2C_IRQ_GPIO_TO_RIQ	IRQ_EINT(4) 
#define CYTTSP5_I2C_RST_GPIO	EXYNOS4212_GPM3(4) /* 127 J6.10, D18, GPMC_AD13/GPIO_37 */
#endif
#endif // CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_I2C
...
static struct i2c_board_info i2c_devs3[] __initdata = {
#ifdef CYTTSP5_USE_I2C	
	{
		...
		.irq =  CYTTSP5_I2C_IRQ_GPIO_TO_RIQ,
...
static struct i2c_board_info i2c_devs6[] __initdata = {	
	...
	{	I2C_BOARD_INFO("ft5x0x_ts_2",0x38),   },
	{	I2C_BOARD_INFO("ilitek_i2c", 0x41),		},
	{	I2C_BOARD_INFO("zet6221-ts", 0x76),		},
};
